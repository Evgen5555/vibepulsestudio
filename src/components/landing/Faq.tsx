...
const faqData: FaqItem[] = [
  {
    ...
    answer:
      "Мы не работаем вслепую. Весь процесс разбит на микро-этапы: сначала утверждаем концепт и мудборд, затем логику (архитектуру) и только потом переходим к сборке. Вы видите проект в реальном времени на каждом шаге. Если на первом этапе поймём, что мы совсем на разных волнах — я просто верну предоплату и мы разойдёмся без обид.",
  },
  {
