...
const reviews: Review[] = [
  {
    ...
    text: "Евгения — гений AI-автоматизации! Создала потрясающий цифровой аватар и упаковала концепт бренда так, что мы выросли в охватах в 3 раза за первую неделю. Быстро, стильно, высокотехнологично!",
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="text-center mb-16 relative z-10">
          ...
          <h2 className="font-semibold tracking-[-0.03em] leading-[1] text-[clamp(2rem,5vw,3.75rem)]">
            Отзывы и <span className="text-gradient-cv">кейсы</span>
          </h2>
        </div>
