...
const cards: Card[] = [
  {
    id: "vizitka",
    title: "Сайт-визитка с портфолио",
    short: "Современный одностраничный сайт с галереей работ, отзывами и формой…",
    full: "Современный одностраничный сайт с галереей работ, отзывами и формой заявки.",
    price: "15 000 ₽",
    duration: "3 дня",
    features: [
      "Адаптивный дизайн ",
      "До 7 секций с вашим контентом",
      "Галерея проектов с описанием",
  ...
  },
  {
    ...
    duration: "1–2 дня",
    features: [
      "До 10 шагов с логикой",
      "Сегментация ответов",
      "Сбор контактов в Telegram",
      "Адаптив под мобильные",
      "Подключение к CRM по запросу",
    ],
    icon: Target,
    tone: "violet",
  },
  {
    ...
    short: "Бот принимает заявки, отвечает на типовые вопросы и хранит контакты…",
    full: "Бот принимает заявки, отвечает на типовые вопросы и хранит контакты клиентов.",
    price: "7 000 ₽",
    duration: "1–2 дня",
    features: [
      "Сценарий приёма заявок",
      "FAQ с автоответами",
      "База контактов",
  ...
  {
    id: "ai-consult",
    title: "AI-консультант под ваш контент",
    short: "AI-помощник, обученный на ваших материалах: отвечает клиентам и…",
    full: "AI-помощник, обученный на ваших материалах: отвечает клиентам и квалифицирует лидов 24/7.",
    price: "15 000 ₽",
    duration: "3–5 дней",
    features: [
      "Обучение на ваших текстах и FAQ",
      "Интеграция в сайт или Telegram",
      "Сценарии продаж и поддержки",
      "Передача сложных вопросов вам",
      "1 месяц правок промта",
    ],
    icon: Sparkles,
    tone: "violet",
  },
  {
    id: "designers",
    title: 'Блок "Для дизайнеров"',
    short: "Отдельный блок-секция для коллег и партнёров с условиями коллаборации.",
    full: "Отдельный блок-секция для коллег и партнёров с условиями коллаборации.",
    price: "3 000 ₽",
    duration: "1 день",
    features: [
  ...
  {
    id: "domain",
    title: "Перенос на ваш домен",
    short: "Подключение домена и хостинга — сайт работает на вашем адресе.",
    full: "Подключение вашего домена и хостинга — сайт работает на собственном адресе.",
    price: "3 000 ₽ + домен/сервер",
    duration: "1 день",
    features: [
