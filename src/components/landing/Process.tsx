...
const steps: Step[] = [
  ...
  },
  {
    n: "2",
    title: "Архитектура",
    desc: "Продумываем, как будет устроено. Выбираем инструменты и стиль",
    icon: Layers,
  ...
  },
  {
    n: "3",
    title: "Сборка",
    desc: "Быстро собираем проект с помощью нейросетей, докручиваем код руками и связываем всё в рабочую систему.",
    icon: Cpu,
