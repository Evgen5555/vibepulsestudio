...
const cards: Card[] = [
  ...
  {
    title: "Вайб - кодинг",
    desc: "Сайты и приложения: от дизайна до интеграции умных AI-сотрудников. Сборка за 3–7 дней. Мобильные приложения. Игры для детей.",
    icon: Code2,
    tone: "cyan",
    className: "",
  },
    ...
    <section id="services" className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="max-w-2xl mb-14 mx-auto text-center">
          <p className="text-sm text-secondary mb-3 text-center">Услуги</p>
          <h2 className="font-semibold tracking-[-0.03em] leading-[1] text-[clamp(2rem,5vw,3.75rem)]">
            <span className="text-gradient-cv">Делаем результат</span>
          </h2>
        </div>
